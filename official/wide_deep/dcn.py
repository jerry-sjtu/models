...
class CrossLayer(base.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        # # print('-' * 60)
        # # print(inputs)
        # outputs = gen_math_ops.mat_mul(self.x0, transpose(inputs, perm=[1, 0]))
        # outputs = gen_math_ops.mat_mul(outputs, self.kernel)
        # outputs = gen_math_ops.add(outputs, self.bias)
        # outputs = gen_math_ops.add(outputs, inputs)
